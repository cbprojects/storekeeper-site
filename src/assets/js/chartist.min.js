    ...
    return (
            ...
            (c.noop = function (a) {
                ...
                (c.getHighLow = function (a, b, d) {
                    ...
                    return (
                        ...
                        f.high <= f.low && (0 === f.low ? (f.high = 1) : f.low < 0 ? (f.high = 0) : (f.low = 0)),
                        f
                    );
                }),
                (c.isNum = function (a) {
                ...
                (c.createChartRect = function (a, b, d) {
                    ...
                    return (
                        e
                            ? ("start" === b.axisX.position ? ((k.y2 = j.top + g), (k.y1 = Math.max(i - j.bottom, k.y2 + 1))) : ((k.y2 = j.top), (k.y1 = Math.max(i - j.bottom - g, k.y2 + 1))),
                              "start" === b.axisY.position ? ((k.x1 = j.left + f), (k.x2 = Math.max(h - j.right, k.x1 + 1))) : ((k.x1 = j.left), (k.x2 = Math.max(h - j.right - f, k.x1 + 1))))
        ...
        (function (a, b, c) {
            ...
            function d(a, d, e, f, g) {
                a instanceof Element ? (this._node = a) : ((this._node = b.createElementNS(z, a)), "svg" === a && this._node.setAttributeNS(A, c.xmlNs.qualifiedName, c.xmlNs.uri)),
                    d && this.attr(d),
                    e && this.addClass(e),
        ...
        (function (a, b, c) {
            ...
            var u = { m: ["x", "y"], l: ["x", "y"], c: ["x1", "y1", "x2", "y2", "x", "y"], a: ["rx", "ry", "xAr", "lAf", "sf", "x", "y"] },
                v = { accuracy: 3 };
            (c.Svg.Path = c.Class.extend({ constructor: f, position: g, remove: h, move: i, line: j, curve: k, arc: l, scale: o, translate: p, transform: q, parse: m, stringify: n, clone: r, splitByCommand: s })),
                    ...
                    function (j, k) {
                        ...
                        (l = h[k + 1] ? h[k + 1] - j : Math.max(this.axisLength - j, 30)),
                            (i[k] || 0 === i[k]) &&
                                ...
                                g.showLabel && c.createLabel(j, l, k, i, this, g.offset, m, b, [e.classNames.label, e.classNames[this.units.dir], e.classNames[g.position]], d, f));
                    }.bind(this)
                );
            }
        ...
        (function (a, b, c) {
            ...
            function d(a) {
                ...
                (d = void 0 === a.axisX.type ? new c.StepAxis(c.Axis.units.x, b, j, c.extend({}, a.axisX, { ticks: b.raw.labels, stretch: a.fullWidth })) : a.axisX.type.call(c, c.Axis.units.x, b, j, a.axisX)),
                    (e =
                        void 0 === a.axisY.type
                            ? new c.AutoScaleAxis(c.Axis.units.y, b, j, c.extend({}, a.axisY, { high: c.isNum(a.high) ? a.high : a.axisY.high, low: c.isNum(a.low) ? a.low : a.axisY.low }))
                ...
                (k = a.distributeSeries && a.stackBars ? d.raw.labels.slice(0, 1) : d.raw.labels),
                    a.horizontalBars
                        ? ((j = m =
                          ...
                          (l = n = void 0 === a.axisY.type ? new c.StepAxis(c.Axis.units.y, d, o, { ticks: k }) : a.axisY.type.call(c, c.Axis.units.y, d, o, a.axisY)))
                        : ((l = m = void 0 === a.axisX.type ? new c.StepAxis(c.Axis.units.x, d, o, { ticks: k }) : a.axisX.type.call(c, c.Axis.units.x, d, o, a.axisX)),
                          (j = n =
                              void 0 === a.axisY.type
                                ...
                                d.normalized[e].forEach(
                                    function (g, k) {
                                        ...
                                        if (
                                            ...
                                            (r = a.horizontalBars
                                                ? { x: o.x1 + j.projectValue(g && g.x ? g.x : 0, k, d.normalized[e]), y: o.y1 - l.projectValue(g && g.y ? g.y : 0, u, d.normalized[e]) }
                                                : { x: o.x1 + l.projectValue(g && g.x ? g.x : 0, u, d.normalized[e]), y: o.y1 - j.projectValue(g && g.y ? g.y : 0, k, d.normalized[e]) }),
        ...
        (function (a, b, c) {
            ...
            function e(a) {
                ...
                for (var o = 0; o < this.data.series.length; o++) {
                    ...
                    if (
                        ...
                        a.donut && u.attr({ style: "stroke-width: " + +a.donutWidth + "px" }),
                        this.eventEmitter.emit("draw", { type: "slice", value: l[o], totalDataSum: i, index: o, meta: p.meta, series: p, group: j[o], element: u, path: t.clone(), center: m, radius: f, startAngle: k, endAngle: q }),
                        a.showLabel)
                    ) {
            ...
            var g = {
                ...
                height: void 0,
                chartPadding: 5,
                classNames: { chartPie: "ct-chart-pie", chartDonut: "ct-chart-donut", series: "ct-series", slicePie: "ct-slice-pie", sliceDonut: "ct-slice-donut", label: "ct-label" },
                startAngle: 0,
                total: void 0,
                donut: !1,
                donutWidth: 60,
